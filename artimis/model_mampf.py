...
class ProbabilityFeatureExtractor:
    ...
    def save(self, path):
        joblib.dump((self.model_benign, self.model_attack), path)

    def load(self, path):
        self.model_benign, self.model_attack = joblib.load(path)

class EnhancedClassifier(nn.Module):
    def __init__(self, input_dim=62, hidden1=64, hidden2=32):
        super().__init__()
