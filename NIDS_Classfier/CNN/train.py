...
from model import MLP,AlertNet,DeepNet,LeNet1D,AlexNet1D,VGG11_1D,VGG16_1D  # 模型存储在model.py中
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,  default='AlexNet', choices=['MLP','LeNet','DeepNet','AlertNet','IdsNet','AlexNet'], help='Model to use for training')
