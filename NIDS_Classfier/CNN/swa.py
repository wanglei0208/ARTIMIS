...
parser.add_argument('--use_swa',action='store_true', help='Whether to use the SWA average model')
args = parser.parse_args()

model_name = 'MLP'
model_ckpt = 'ARTIMIS/CNN/2018/brute_force/MLP/models/best_f1_model.pth'
save_path = 'ARTIMIS/CNN/2018/brute_force/MLP/0.01.pth'
...
model = get_model(model_name, num_classes=2, input_dim=X_train.shape[1]).to(device)
